...
//   if (s === "billed")   return "border-green-400  bg-green-50  text-green-700"
...
//   : s === "billed"   ? "bg-green-400 animate-pulse"
...
// function TableGrid({ tables, loading, selectedTable, onSelect, onRefresh, selectLoading }) {
//   if (loading) {
//     return (
...
//             <span className="font-semibold text-zinc-700">Rs. {subtotal}</span>
//           </div>
//           {totalDiscount > 0 && (
//             <div className="flex justify-between items-center text-sm">
//               <span className="text-zinc-500">Discount</span>
//               <span className="font-semibold text-emerald-600">− Rs. {totalDiscount}</span>
//             </div>
//           )}
//           <div className="flex justify-between items-center text-sm">
//             <span className="text-zinc-500">VAT ({VAT_PERCENT}%)</span>
//             <span className="font-semibold text-zinc-700">Rs. {vatAmount}</span>
//           </div>
//           {tipAmount > 0 && (
//             <div className="flex justify-between items-center text-sm">
//               <span className="text-zinc-500">Tip</span>
//               <span className="font-semibold text-zinc-700">Rs. {tipAmount}</span>
//             </div>
//           )}
//         </div>
...
//   const vatAmount          = Math.round(discountedSubtotal * (VAT_PERCENT / 100))
//   const tipAmount          = useCustomTip
//     ? (Number(customTip) || 0)
//     : Math.round(discountedSubtotal * (tipPercent / 100))
//   const total = discountedSubtotal + vatAmount + tipAmount
